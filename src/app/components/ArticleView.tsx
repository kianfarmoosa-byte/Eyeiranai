...
export function ArticleView({ article, onClose, toggleStar, toggleSave, isSaved, onTagsChange, related, onSelectRelated, onOpenTimeline }: Props) {
  ...
  if (!article) {
    return (
      <aside className="w-[480px] bg-slate-50 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex items-center justify-center text-slate-500">
        مقاله‌ای برای نمایش انتخاب کنید
      </aside>
    );
  }
